...
class ClustersView(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            # Check if its a liqo cluster
            try:
                configMap = kube_client.kube.read_namespaced_config_map(
                    name='liqo-clusterid-configmap',
                    namespace='liqo')
                liqo_cluster_id = configMap.data['CLUSTER_ID']
                validated_cluster_data['liqo_name'] = liqo_cluster_id
            except:
                pass
